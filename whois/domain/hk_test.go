...
func TestHKTLDParser_Parse(t *testing.T) {
	...
	assertHKBasicFields(t, parsedWhois)
	assertHKContacts(t, parsedWhois)
	assertHKNameServers(t, parsedWhois)
...
func assertHKBasicFields(t *testing.T, parsedWhois *ParsedWhois) {
	// Verify domain name
...
func assertHKContacts(t *testing.T, parsedWhois *ParsedWhois) {
	assertHKRegistrant(t, parsedWhois)
	assertHKAdmin(t, parsedWhois)
	assertHKTech(t, parsedWhois)
}

func assertHKRegistrant(t *testing.T, parsedWhois *ParsedWhois) {
...
func assertHKAdmin(t *testing.T, parsedWhois *ParsedWhois) {
...
func assertHKTech(t *testing.T, parsedWhois *ParsedWhois) {
...
func assertHKNameServers(t *testing.T, parsedWhois *ParsedWhois) {
