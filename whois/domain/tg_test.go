...
func TestTGParser(t *testing.T) {
	...
	t.Run("registered domain", func(t *testing.T) {
		...
		assertTGBasicFields(t, result)
		assertTGContacts(t, result)
		assertTGNameServers(t, result)
	})
	...
	t.Run("unregistered domain", func(t *testing.T) {
		...
		assertTGUnregisteredDomain(t, result)
	})
}

func assertTGBasicFields(t *testing.T, result *ParsedWhois) {
...
func assertTGContacts(t *testing.T, result *ParsedWhois) {
...
func assertTGNameServers(t *testing.T, result *ParsedWhois) {
...
func assertTGUnregisteredDomain(t *testing.T, result *ParsedWhois) {
